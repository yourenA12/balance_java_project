...
public interface TransferVoMapper extends BaseMapper<TransferVo> {
    //更具id 查询人事异动详情信息
    @Select("SELECT A.AUDITFLOW_ID,E.STAFF_NAME AS STAFF_NAME1,EE.STAFF_NAME AS STAFF_NAME2,C.TRANSFER_TYPE,C.CREATED_DEPT_ID,C.UPDATED_DEPT_ID,C.TRANSFER_STATE,C.TRANSFER_RAWPOST_ID,C.TRANSFER_AFTERPOST_ID,E.POSITION_ID,f.POSITION_NAME,d.dept_name,d1.dept_name as dept_name1,B.AUDITFLOWDETAI_STATE\n" +
            "FROM AUDITFLOW A\n" +
            "LEFT JOIN \n" +
            "AUDITFLOWDETAIL B\n" +

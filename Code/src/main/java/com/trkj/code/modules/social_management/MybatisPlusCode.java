package com.trkj.code.modules.social_management;
...
//        packageConfig.setModuleName("mybatisplus");
        //放在哪一个包下
        packageConfig.setParent("com.trkj.balance.modules.social_management");
...
//        packageConfig.setController("controller");
        ...
        //数据库表名 自己写自己模块的表名
        strategyConfig.setInclude("INSURED_DETAIL_SON");// 不写默认生成所有的表！！！
        //包的命名规则

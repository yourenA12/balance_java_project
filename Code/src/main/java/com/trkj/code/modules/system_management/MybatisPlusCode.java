package com.trkj.code.modules.system_management;
...
//        packageConfig.setModuleName("mybatisplus");
        //放在哪一个包下
        packageConfig.setParent("com.trkj.balance.modules.system_management");
...
//        packageConfig.setController("controller");
        ...
        //数据库表名 自己写自己模块的表名
        strategyConfig.setInclude("NOTICE","NOTICE_DEPT","DEPT");// 不写默认生成所有的表！！！
        //包的命名规则

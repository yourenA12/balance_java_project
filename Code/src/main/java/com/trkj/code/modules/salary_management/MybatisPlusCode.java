package com.trkj.code.modules.salary_management;
...
//        packageConfig.setModuleName("mybatisplus");
        //放在哪一个包下
        packageConfig.setParent("com.trkj.balance.modules.salary_management");
...
//        packageConfig.setController("controller");
        ...
        //数据库表名 自己写自己模块的表名
        strategyConfig.setInclude("COMPENSATION_STAFF");// 不写默认生成所有的表！！！
